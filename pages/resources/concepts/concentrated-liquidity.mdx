...
<img src="/animations/ticks.webp" class="w-full mt-8"/>

For more information on fee levels and their correlation to tick spacing, see the [whitepaper](/whitepaper-v3.pdf).

---

[^1]: Tick interval refers to the area of price space between two nearest active ticks
[^2]: Animation courtesy of Uniswap Foundation.